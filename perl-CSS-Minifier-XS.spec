...
Version  : 0.11
Release  : 17
URL      : https://cpan.metacpan.org/authors/id/G/GT/GTERMARS/CSS-Minifier-XS-0.11.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/G/GT/GTERMARS/CSS-Minifier-XS-0.11.tar.gz
...
%prep
%setup -q -n CSS-Minifier-XS-0.11
cd %{_builddir}/CSS-Minifier-XS-0.11
...
cp %{_builddir}/CSS-Minifier-XS-0.11/LICENSE %{buildroot}/usr/share/package-licenses/perl-CSS-Minifier-XS/c5ee82fe20ef37bf6fa49ec78a87e5111ee51416
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-CSS-Minifier-XS/c5ee82fe20ef37bf6fa49ec78a87e5111ee51416

%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/x86_64-linux-thread-multi/CSS/Minifier/XS.pm
/usr/lib/perl5/vendor_perl/5.30.3/x86_64-linux-thread-multi/auto/CSS/Minifier/XS/XS.so
